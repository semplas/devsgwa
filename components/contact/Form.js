        ...
        <div className="max-w-5xl px-10 mx-auto xl:px-5">
          <div className="flex flex-col justify-center space-y-8">
            ...
            >
              <input
                type="text"
                className="flex-1 w-full px-5 py-5 text-2xl border border-gray-300 rounded-lg focus:ring-4 focus:border-purple-700 focus:ring-blue-600 focus:ring-opacity-50 focus:outline-none"
