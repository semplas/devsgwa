        ...
        <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
          <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
            ...
            <div className="flex flex-col items-center pt-2 sm:flex-row sm:pt-4">
              <Link href="/contact">
                <span className="inline-flex items-center justify-center w-full h-12 px-6 mb-4 font-medium tracking-wide text-white transition duration-200 bg-blue-500 rounded shadow-md sm:w-auto sm:mr-4 sm:mb-0 hover:bg-deep-blue-accent-700 focus:shadow-outline focus:outline-none">
                  Request Quote
                </span>
              </Link>
              <Link href="/contact">
                <span className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 bg-gray-700 rounded shadow-md sm:w-auto hover:bg-deep-blue-accent-700 focus:shadow-outline focus:outline-none">
                  Contact Us
                </span>
              </Link>
            </div>
