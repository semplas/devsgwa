    ...
    <>
      <section className="bg-white">
        <div className="px-8 py-8 mx-auto max-w-7xl">
          <div className="relative px-6 py-10 overflow-hidden border border-blue-100 lg:p-16 lg:flex lg:flex-col lg:items-center lg:justify-between rounded-none">
            ...
            <div className="absolute bottom-0 right-0 z-10 hidden h-full p-4 mt-1 ml-3 -mb-4 -mr-4 transform rotate-90 md:block">
              ...
              >
                ...
                <g fill-rule="nonzero">
                  ...
                  <circle cx="158" cy="121" r="9.5"></circle>
                  <circle cx="195" cy="121" r="9.5"></circle>
                  <circle cx="232" cy="121" r="9.5" className=""></circle>
                  <circle cx="269" cy="121" r="9.5"></circle>
                  <circle cx="306" cy="121" r="9.5" className=""></circle>
                  <circle cx="343" cy="121" r="9.5"></circle>
                  <circle cx="380" cy="121" r="9.5"></circle>
                  <circle cx="158" cy="158" r="9.5"></circle>
                  <circle cx="195" cy="158" r="9.5"></circle>
            ...
            <div className="relative z-20 flex flex-col items-center w-full space-y-5 md:space-x-5 md:space-y-0 md:flex-row md:w-auto lg:flex-shrink-0 md:px-0">
              <a
                href="#_"
                className="block w-full px-5 py-3 text-base font-medium leading-6 text-center text-white transition duration-150 ease-in-out bg-blue-600 md:inline-flex md:shadow-sm md:w-auto hover:bg-blue-500 focus:outline-none focus:shadow-outline rounded-none"
              >
                Contact Us
              </a>
              <a
                href="#_"
                className="block w-full px-5 py-3 text-base font-medium leading-6 text-center text-blue-600 transition duration-150 ease-in-out bg-blue-100 md:inline-flex md:shadow-sm md:w-auto hover:bg-blue-50 focus:outline-none focus:shadow-outline rounded-none"
              >
                Request a Quote
              </a>
            </div>
